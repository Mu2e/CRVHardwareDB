...
##
##
##  A python scriipt to tabulate the side, position and layer of a missing di-counter, smb or cmb
##
##  Modifed from "checkMOdule.py"
    ...
    for mm in range(0,4):
      ...
      ##   --- smb ---
        ...
        if(self.__localSide == 'top') : 
          try:
            ...
            ## cmj2022May16
            int_nnn = int(nnn)+1
            ##cmj2023May15 print(("__setStatusGrid: Missing smb: side = %s position = %s layer = %s \n") % (self.__localSide, str(int_nnn), mmm))
            print(("__setStatusGrid: Missing smb: side = %s layer = %s position = %s  \n") % (self.__localSide, mmm, str(int_nnn)))
            ## cmj2022May16
          ...
          try:
            ...
            ## cmj2022May16
            int_nnn = int(nnn)+1
            ##cmj2023May16 print(("__setStatusGrid: Missing smb: side = %s position = %s layer = %s \n") % (self.__localSide, str(int_nnn), mmm))
            print(("__setStatusGrid: Missing smb: side = %s layer = %s  position = %s \n") % (self.__localSide, mmm, str(int_nnn)))
            ## cmj2022May16
      ...
      ##    ---- cmb ----
        ...
        if(self.__localSide == 'top') : 
          try:
            ...
            ## cmj2022May16
            int_nnn = int(nnn)+1
            ##cmj2023May16 print(("__setStatusGrid: Missing cmb: side = %s position = %s layer = %s \n") % (self.__localSide, str(int_nnn), mmm))
            print(("__setStatusGrid: Missing cmb: side = %s layer = %s  position = %s  \n") % (self.__localSide, mmm, str(int_nnn)))
            ## cmj2022May16
        elif(self.__localSide == 'bottom') : 
          try:
      ...
      ##  --- diCounters ---
        ...
        try:
          ...
          ## cmj2022May16
          int_nnn = int(nnn)+1
          ##cmj2023May16 print(("__setStatusGrid: Missing di_counter: side = %s position = %s layer = %s \n") % (self.__localSide, str(int_nnn), mmm))
          print(("__setStatusGrid: Missing di_counter: side = %s layer = %s position = %s \n") % (self.__localSide, mmm, str(int_nnn)))
          ## cmj2022May16
      ...
      ##  -- Sipms ---
        ...
        for pp in range(0,4):
          ...
          if(self.__tempSipmId2[0] == 'A') : self.__tempColor = self.__moduleSipmSignOff_dict[self.__tempSipmId2]
            ...
            self.__tempColor = 'white'
            ## cmj2022May16
            int_nnn = int(nnn)+1
            ##cmj2023May16 print(("__setStatusGrid: Missing di_counter: side = %s position = %s layer = %s \n") % (self.__localSide, str(int_nnn), mmm))
            print(("__setStatusGrid: Missing sipm: side = %s layer = %s position = %s sipm_position = %s \n") % (self.__localSide, mmm, str(int_nnn),ppp))
            ## cmj2022May16
